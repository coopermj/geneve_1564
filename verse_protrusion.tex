...
% NOTE: detection assumes verse numbers are set in the main body font (the font active at begin-document). If an edition sets verse numbers in a different family lacking superior figures, detection may report available while rendering shows none (no crash; just no hang).
